...
<div><strong>Policies</strong><a href="/editorial-policy/">Editorial policy</a><a href="/safety/">Safety</a><a href="/about/">About</a></div>
...
# Crawling files.
urls = [url(), url("about/"), url("editorial-policy/"), url("safety/")]
